        ...
        document.getElementById('loginForm').addEventListener('submit', async (e) => {
          ...
          try {
            ...
            if (response.ok) {
              ...
              resultDiv.innerHTML = '<h3>✅ Login Successful!</h3>' +
...
console.log('🚀 VibeMarket Test Server Starting...');
console.log('📍 URL: http://localhost:' + PORT);
console.log('👤 Admin Email: nick@sportwise.ai');
console.log('🔑 Password: Sloan2018!');
console.log('The server includes a login test page to verify your admin credentials work.');
